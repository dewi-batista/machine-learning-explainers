...
\subsubsection{\NEXT Quirks of VAEs}
\begin{itemize}
    \item[--] Blur is often observed outside of the central object, i.e. the model is learning the foreground but not the background of training samples.
    \item[--] \dots
\end{itemize}
