...
% abstract
\begin{abstract}
    \noindent Summaries of a bunch of machine learning-related topics. My main motive in writing these summaries is as a reminder for future me.
\end{abstract}
...
A lost art in the era of deep learning\dots
...
$$
The quantity pertaining to the quality of the learning procedure (used to determine $\hat{f}_{D}$ from $D\in\Omega_{\D}$) is then
\begin{align*}
