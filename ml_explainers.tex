...
\subsubsection{Backpropagation (reverse-mode auto-differentiation)}
...
\subsubsection{\NEXT Backpropagation for CNNs}
\dots

\subsubsection{Backpropagation for RNNs}
\dots

\subsubsection{Backpropagation for Transformers}
There's nothing interesting to be said about backpropagating through vanilla transformer architectures given known methods of backpropagating through MLPs (linear layers and non-linear activation functions) and normalisations.
...
Since generated samples are not labeled, how does one evaluate generative models? % What does under/overfitting mean for generative models?
...
\subsection{\NEXT Quality of fit $\approx$ Encoding quality?}
\dots
