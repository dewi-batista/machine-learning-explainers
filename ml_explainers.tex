...
\texttt{MLP}
$$
each of which will be detailed in this subsection\footnote{For a great visualisation, consider \url{poloclub.github.io/transformer-explainer/}.}.
...
or
$$
E(\text{Wales})+E(\text{Cardiff})-E(\text{Italy})
\approx
E(\text{Rome}).
$$
...
\subsubsection{MLP component and output}
