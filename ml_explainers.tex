...
% abstract
\begin{abstract}
    \noindent Summaries of some machine/deep learning-related topics. My main motive in writing these summaries is as a reminder for my future self. A notation page is given at the beginning of the appendix.
\end{abstract}
...
\TODO{}The expectation term in the ELBO requires us to sample from $q_{\phi}(\z|\x)$. Back propping through sampling is not a thing, it ain't differentiable. We need the reparameterisation trick!
...
% notation page
\section{\TODO{}Notation}
$X$ \hfill A random variable.

$x$ \hfill A realisation/assignment of the random variable $X$.

% probability things
\section{Probability Theory and Statistics Things}
Here are some probability theory and statistics-related things, e.g. brief statements, long derivations, and so on, which belong in an appendix. I've considered splitting it into two appendix sections — one for probability theory and one for statistics — but I couldn't decide in which I should put certain subsections, e.g. would Pearson correlation belong in the probability theory or statistics section?

P.S. I advise people who are entirely new to probability theory and statistics to consider playing around with interative visual demonstrations of ideas, as in \href{https://seeing-theory.brown.edu/index.html}{\texttt{seeing-theory.brown.edu/index.html}}. I wish I had a better understanding of probability theory, measure theory and classical statistics. In another life.
