...
% transformer models
\subsection{\IMPROVE Transformers}
...
L_E(\text{``Rome"})
$$
where $``\text{word}''$ denotes the basis vector corresponding to the word according to some indexing over the vocabulary, e.g. perhaps $|V|=50,000$ and ``Germany''$=e_{35,629}$. So how is the embedding matrix $E\in\R^{d\times |V|}$ learned?
