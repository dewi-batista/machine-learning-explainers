...
\subsection{Flavours of Convergence of Random Variables}
...
\subsection{\TODO Bayesian Persuasion}
...
\subsection{\TODO Markov Chains}
In the following I keep things particularly simple and only consider discrete distributions.

\subsubsection{Markov Chain Monte Carlo (MCMC)}
Sampling from nasty distributions whose probability function can be computed up to a constant.

\subsubsection*{Example 1: The Metropolis-Hastings algorithm}

\subsubsection*{Example 2: Gibbs sampling}
